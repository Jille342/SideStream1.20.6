    ...
    public static final class ListGui extends ListWidget {
        ...
        protected void renderItem(DrawContext context, int id, int x, int y,
            ...
            context.drawText(MinecraftClient.getInstance().textRenderer,
                "Name: " + alt.getUsername(), x + 31, y + 3, 10526880, false);
            context.drawText(client.textRenderer, "Name: " + alt.getUsername(),
                x + 31, y + 3, 10526880, false);
        }
    }
}
