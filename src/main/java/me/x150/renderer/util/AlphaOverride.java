...
/**
 * An alpha override utility. Has the ability to modify the color of any element
 * on screen, rendered by the library
 */
public class AlphaOverride {
    ...
    /**
     * Computes the new alpha from the initialAlpha, based on the current state
     * of the stack
     *
